...
func (c *iPAddressServiceClient) AssignAddress(ctx context.Context, in *AssignAddressRequest, opts ...grpc.CallOption) (*AssignAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, IPAddressService_AssignAddress_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *iPAddressServiceClient) ReleaseAddress(ctx context.Context, in *ReleaseAddressRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, IPAddressService_ReleaseAddress_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *iPAddressServiceClient) ListAddresses(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListAddressesResponse, error) {
	...
	err := c.cc.Invoke(ctx, IPAddressService_ListAddresses_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *iPAddressServiceClient) UpdateAddress(ctx context.Context, in *UpdateAddressRequest, opts ...grpc.CallOption) (*UpdateAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, IPAddressService_UpdateAddress_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterIPAddressServiceServer(s grpc.ServiceRegistrar, srv IPAddressServiceServer) {
	// If the following call pancis, it indicates UnimplementedIPAddressServiceServer was
